...
class Obstacles {
	...
	respawnObstacle(obstacle: Three.Object3D) {
	...
	update(pos: any, time: number) {
		let collisionObstacle: any;
		...
		if (collisionObstacle !== undefined) {
			collisionObstacle.children.some((child: any) => {
